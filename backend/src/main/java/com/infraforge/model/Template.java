 ...
 *
 * share_token is a nullable UUID generated on demand when the owner shares a
 * template. NULL means private; non-null means accessible via the public
 * /api/v1/shared/{token} endpoint. Setting it back to NULL revokes access.
 */
@Entity
...
public class Template {
    ...
    /** Owner of this template — nullable for backward compat with pre-auth templates */
    @Column(name = "user_id")
    private UUID userId;

    /**
     * Public share token — null means private.
     * Generated by the owner via POST /api/v1/templates/{id}/share.
     * Revoked by setting to null via DELETE /api/v1/templates/{id}/share.
     */
